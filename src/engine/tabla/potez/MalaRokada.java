...
public class MalaRokada extends Rokada {
    public MalaRokada(Tabla pozicija, Figura pomerenaFigura, int koordinataDestinacije, Top top, int topPocetnaKoordinata, int topZavrsnaKoordinata) {
